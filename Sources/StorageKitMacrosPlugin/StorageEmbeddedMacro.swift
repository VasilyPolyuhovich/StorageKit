...
public struct StorageEmbeddedMacro: PeerMacro {
    public static func expansion(
        ...
        // The @StorageEntity macro reads @StorageEmbedded attributes and handles flattening
        return []
    }

    /// Extract prefix from @StorageEmbedded(prefix: "xxx") attribute
